  ...
  context 'GET /api/v1/suppliers/search?categoria_id&state_id&operator' do
    context 'using operator OR' do
      it 'success' do
        ...
        get "/api/v1/suppliers/search?category_id=#{category.id}&state_id=#{bahia.id}&operator=or"
      ...
      it 'not found' do
        get "/api/v1/suppliers/search?category_id=777&state_id=777&operator=OR"
